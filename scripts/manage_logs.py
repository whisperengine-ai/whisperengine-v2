...
def main():
    ...
    parser.add_argument(
        "--action",
        choices=["stats", "archive", "cleanup", "compress"],
        required=True,
        help="Action to perform",
    )
    parser.add_argument(
        "--days-old", type=int, default=7, help="Days old for archiving (default: 7)"
    )
    parser.add_argument(
        "--days-to-keep",
        type=int,
    ...
    parser.add_argument("--compress", action="store_true", help="Compress logs when archiving")
    parser.add_argument(
