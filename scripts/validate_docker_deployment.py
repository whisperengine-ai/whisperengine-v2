...
class DockerComposeValidator:
    ...
    def wait_for_services(self, timeout: int = 120) -> bool:
        ...
        while time.time() - start_time < timeout:
            ...
            try:
                ...
                logger.info(f"Healthy: {len(healthy_services)}/{len(services)} - {', '.join(healthy_services)}")
    ...
    def test_service_connectivity(self) -> bool:
        ...
        for test in tests:
            ...
            if result["success"] and (not test["expected_in_output"] or test["expected_in_output"] in result["stdout"]):
    ...
    def test_database_schema(self) -> bool:
        ...
        expected_tables = ["users", "conversations", "memory_entries", "facts", "emotions", "relationships", "system_settings", "performance_metrics"]
