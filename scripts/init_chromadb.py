    ...
    async def _connect(self) -> bool:
        ...
        try:
            ...
            settings = Settings(
                ...
                chroma_client_auth_provider="chromadb.auth.basic.BasicAuthClientProvider" if self.enable_auth else None
            )
    ...
    async def _verify_collection_schema(self, name: str, config: Dict) -> bool:
        ...
        try:
            ...
            if expected_fields != actual_fields:
                logger.warning(f"Collection '{name}' schema mismatch: expected {expected_fields}, got {actual_fields}")
                return False
