...
def test_phase_integration_optimizer():
    ...
    try:
        ...
        print(f"   Phase 2 result: {sample_results['phase2'].success} "
              f"({sample_results['phase2'].processing_time:.3f}s)")
        print(f"   Phase 3 result: {sample_results['phase3'].success} "
        ...
        print(f"   Average Phase 2 timing: {report['average_phase_timings']['phase2']['average']:.3f}s")
        print(f"   Average Phase 3 timing: {report['average_phase_timings']['phase3']['average']:.3f}s")
