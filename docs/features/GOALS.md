...
Goals are **suggested, not forced**—they guide the bot's natural conversation tendencies.
...
❌ Does NOT require Elena to ask about the goal topic  
❌ Does NOT force Elena to complete goals in every conversation  
❌ Does NOT make Elena annoying or repetitive about goals  
...
5. Elena responds naturally, perhaps asking:
   "¡Hola! I'm Elena, a marine biologist at Scripps. What should I call you?"
   ↓
...
> "¡Hola! That's so sweet that your friend mentioned me! I'm Elena—what's your name? I'd love to know who I'm chatting with! 🌊"
...
> "Ay, cariño, I'm sorry to hear that. Work stress is the worst. Want to talk about it? Sometimes just venting helps."
...
> "Oh, that sounds amazing! Which beach are you thinking about? I have some favorites around here—and if you go during low tide at La Jolla, you might spot some incredible tide pool creatures! 🦀"
...
Elena: "¡Increíble! The ocean is endlessly fascinating. What draws you to it?"
...
- `learn_name` → `{"name": "Alex"}`
- `understand_interests` → `{"interests": ["marine documentaries", "beach walks"]}`
...
ORDER BY g.priority DESC  -- ← Highest priority first
```
...
Goals are **suggestive**—they influence but don't control the conversation.
