...
research/
├── README.md                    # This file
├── METHODOLOGY.md               # Research approach & principles
├── templates/
│   ├── DAILY_LOG.md             # Daily observation template
│   ├── WEEKLY_SUMMARY.md        # Weekly synthesis template
│   └── EXPERIMENT.md            # Experiment design template
├── journal/
│   ├── 2024-12/                 # Monthly folders
│   │   ├── 2024-12-01.md        # Daily logs
│   │   └── week-01.md           # Weekly summaries
│   └── ...
└── experiments/
    ├── E001_feedback_loops.md   # Individual experiments
    └── ...
```
