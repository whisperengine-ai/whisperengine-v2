...
class WhisperEngineDatabaseConfig:
    ...
    def get_database_manager(self) -> DatabaseManager:
        ...
        db_type_override = os.environ.get('WHISPERENGINE_DATABASE_TYPE', self.db_config.primary_type)
...
def create_database_integration(adaptive_config_manager: Optional[AdaptiveConfigManager] = None) -> DatabaseIntegrationManager:
