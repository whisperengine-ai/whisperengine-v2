...
class SimpleDatastoreFactory:
    ...
    def _create_fallback_vector_storage(self, **kwargs) -> Any:
        ...
        class SimpleFallbackVectorStorage:
            ...
            def query(self, query_texts, n_results=10, **kwargs):
                ...
                query = query_texts[0].lower() if isinstance(query_texts, list) else query_texts.lower()
    ...
    def create_graph_storage(self) -> Any:
        ...
        class SimpleGraphStorage:
            ...
            def add_edge(self, from_node: str, to_node: str, relationship: str, properties: Optional[Dict[str, Any]] = None):
                self.edges.append({
                    'from': from_node,
                    'to': to_node,
    ...
    def get_availability_info(self) -> Dict[str, Any]:
        ...
        info = {
            ...
            'conversation_cache': 'desktop_sqlite' if self.deployment_mode == DeploymentMode.DESKTOP else 'fallback',
            'vector_storage': 'local_files' if self.deployment_mode == DeploymentMode.DESKTOP else 'fallback',
