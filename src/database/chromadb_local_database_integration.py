...
class ChromaDBLocalDatabaseManager(DatabaseIntegrationManager):
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            self.chromadb_manager = ChromaDBManagerSimple(
        ...
        try:
            ...
            for collection_name in collection_names:
                try:
                    ...
                    try:
                        collection = self.chromadb_manager.client.create_collection(name=collection_name)
                ...
                try:
                    ...
                    status['components']['chromadb'] = {
                        ...
                        'collections': {
                            ...
                            'global_collection': self.chromadb_manager.global_collection is not None
                        }
                    }
                except Exception as e:
