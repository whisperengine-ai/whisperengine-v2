...
class HumanLikeSearchQuery:
    ...
    query: str
    weight: float = 1.0
    query_type: str = "conversational"  # "emotional", "personal", "topical", "contextual", "relational"
...
class HumanLikeLLMProcessor:
    ...
    def __init__(self, llm_client, personality_type: str = "caring_friend"):
        ...
        self.human_optimizer = create_human_like_memory_optimizer(
...
Flow analysis: {flow_optimization.get('flow_analysis', {})}"""
    ...
    def _parse_human_like_response(
        ...
        if not primary_queries:
            primary_queries = [HumanLikeSearchQuery(
    ...
    def _calculate_emotional_resonance(self, query: str, query_type: str) -> float:
        ...
        emotional_keywords = [
            'feeling', 'emotion', 'happy', 'sad', 'excited', 'worried', 'love', 'fear',
            'joy', 'anger', 'frustrated', 'grateful', 'proud', 'disappointed', 'hopeful'
        ]
    ...
    def _calculate_relationship_relevance(
        ...
        relationship_keywords = [
            'we', 'us', 'our', 'together', 'shared', 'both', 'remember', 'discussed',
            'talked', 'mentioned', 'told', 'asked', 'helped', 'supported'
        ]
    ...
    def _create_safe_fallback_query(self, message: str) -> str:
        ...
        stop_words = {
            ...
            'do', 'does', 'did', 'have', 'has', 'had', 'what', 'how', 'why', 'when',
            'where', 'who', 'just', 'really', 'very', 'so', 'too', 'now', 'then'
        }
...
class HumanLikeMemorySearch:
    ...
    async def search_like_human_friend(
        ...
        try:
            ...
            final_memories = self._rank_memories_like_human(
                all_memories, human_result, limit
            )
