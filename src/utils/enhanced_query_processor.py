...
class EnhancedQueryProcessor:
    ...
    def __init__(self):
        ...
        self.stop_words = {
            ...
            'who', 'why', 'which', 'this', 'that', 'these', 'those', 'in', 'on', 'at', 'to', 'for',
            'of', 'with', 'by', 'from', 'about', 'into', 'through', 'during', 'before', 'after',
            'above', 'below', 'up', 'down', 'out', 'off', 'over', 'under', 'again', 'further',
            'do', 'does', 'did', 'doing', 'will', 'would', 'should', 'could', 'can', 'may', 'might',
            'must', 'shall', 'have', 'has', 'had', 'having', 'today', 'yesterday', 'tomorrow',
            'tell', 'help', 'please', 'thanks', 'thank', 'you', 'your', 'yours', 'yourself',
            'he', 'him', 'his', 'himself', 'she', 'her', 'hers', 'herself', 'it', 'its', 'itself',
            'we', 'us', 'our', 'ours', 'ourselves', 'they', 'them', 'their', 'theirs', 'themselves',
            'just', 'really', 'very', 'too', 'now', 'here', 'there', 'some', 'any', 'more', 'most',
            'other', 'such', 'only', 'own', 'same', 'so', 'than', 'too', 'very', 'well'
        }
        ...
        self.emotion_indicators = {
            'positive': ['happy', 'excited', 'joy', 'love', 'great', 'awesome', 'amazing', 'fantastic'],
            'negative': ['sad', 'angry', 'frustrated', 'annoyed', 'upset', 'worried', 'stressed', 'anxious'],
        ...
        self.topic_categories = {
            ...
            'relationships': ['friend', 'relationship', 'dating', 'partner', 'boyfriend', 'girlfriend'],
            'hobbies': ['hobby', 'music', 'guitar', 'piano', 'art', 'drawing', 'painting', 'reading'],
            'cooking': ['cook', 'cooking', 'recipe', 'food', 'meal', 'kitchen', 'baking', 'restaurant'],
            'technology': ['computer', 'software', 'app', 'internet', 'tech', 'programming', 'code'],
    ...
    def _is_significant_word(self, word: str) -> bool:
        ...
        return (
            ...
            word not in self.question_words
        )
    ...
    def _classify_intent(self, message: str) -> str:
        ...
        if any(word in message for word in ['love', 'hate', 'like', 'dislike', 'prefer', 'think', 'feel']):
            return "preference"
    ...
    def _generate_primary_queries(self, entities: List[str], intent: str, emotion: Optional[str], 
                                message: str) -> List[SearchQuery]:
