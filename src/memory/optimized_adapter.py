...
class OptimizedMemoryAdapter:
    ...
    async def get_global_facts(self, category: Optional[str] = None, limit: int = 20) -> List[Dict]:
    ...
    async def warm_up_cache(
        self, common_queries: Optional[List[str]] = None, user_ids: Optional[List[str]] = None
    ) -> Dict[str, Any]:
