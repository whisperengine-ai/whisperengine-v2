...
from ..graph_database.models import (
    GlobalFactNode, KnowledgeDomainNode, FactRelationshipTypes, KnowledgeDomains
)
...
class GraphMemoryManager:
    ...
    async def _ensure_default_domains(self) -> None:
        ...
        default_domains = [
            ...
            (KnowledgeDomains.CHEMISTRY, "Chemistry and chemical processes", KnowledgeDomains.SCIENCE),
            (KnowledgeDomains.BIOLOGY, "Biology and life sciences", KnowledgeDomains.SCIENCE),
            (KnowledgeDomains.MATHEMATICS, "Mathematics and mathematical concepts", KnowledgeDomains.SCIENCE),
            
            # Social sciences
            (KnowledgeDomains.PSYCHOLOGY, "Psychology and human behavior", KnowledgeDomains.SCIENCE),
            (KnowledgeDomains.SOCIOLOGY, "Sociology and social structures", KnowledgeDomains.SCIENCE),
            (KnowledgeDomains.ECONOMICS, "Economics and economic systems", KnowledgeDomains.SCIENCE),
            ...
            (KnowledgeDomains.GEOGRAPHY, "Geography and spatial knowledge", KnowledgeDomains.SCIENCE),
        ]
    ...
    async def store_global_fact_hybrid(self, chromadb_id: str, fact_content: str,
    ...
    async def create_fact_relationship(self, fact_id_1: str, fact_id_2: str,
        ...
        try:
            ...
            if success:
                logger.debug(f"Created {relationship_type} relationship between {fact_id_1} and {fact_id_2}")
    ...
    async def get_related_facts(self, chromadb_id: str, relationship_types: Optional[List[str]] = None,
    ...
    async def update_fact_verification(self, chromadb_id: str, verification_status: str,
    ...
    async def find_supporting_facts(self, chromadb_id: str, max_depth: int = 2) -> List[Dict[str, Any]]:
