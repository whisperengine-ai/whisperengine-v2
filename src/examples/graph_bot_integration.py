...
class GraphEnhancedBot:
    ...
    async def process_message(self, user_id: str, message: str) -> dict[str, Any]:
        ...
        try:
            ...
            context = await self.memory_manager.get_personalized_context(user_id, message, limit=10)
            ...
            return {
                ...
                "context_used": {
                    ...
                    "graph_memories": len(
                        context.get("graph_context", {}).get("graph_memories", [])
                    ),
                    "relationship_intimacy": context.get("graph_context", {})
                    .get("relationship_context", {})
                    .get("intimacy_level", 0.3),
        ...
        try:
            ...
            return {
                ...
                "summary": self._generate_relationship_summary(
                    relationship_context, emotional_patterns
                ),
            }
