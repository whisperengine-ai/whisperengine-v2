...
class HelpCommandHandlers:
    ...
    async def _detailed_help_handler(self, ctx, is_admin):
        ...
        embed.add_field(name="🧠 AI Chat", value=chat_info, inline=False)
        ...
        if self.voice_manager and self.voice_support_enabled:
            voice_commands = [
                ...
                (
                    f"!voice_chat_test{name_suffix}",
                    "Test voice chat functionality (aliases: !vctest)",
                ),
                (
                    f"!voice_connection_status{name_suffix}",
                    "Show voice connection status (aliases: !vcs)",
                ),
                (f"!voice_help{name_suffix}", "Show voice commands help (aliases: !vhelp)"),
                (
                    "!voice_toggle_listening",
                    "Toggle voice listening on/off (Admin, aliases: !vtl, !toggle_listen)",
                ),
        ...
        if self.personality_profiler:
            analysis_commands.append(
                (
                    f"!personality{name_suffix} [user]",
                    "🧠 View personality profile (aliases: !profile, !my_personality)",
                )
            )
        ...
        if is_admin(ctx):
            admin_commands = [
                ...
                (
                    ...
                    "Show emotional intelligence system status (aliases: !ei_status, !emotional_status)",
                ),
                ...
                (
                    "!remove_global_fact_by_number <num> <search>",
                    "Remove a specific global fact by number",
                ),
            ]
        ...
        embed.set_footer(
            text="Quick help: !help or !h • This detailed view: !commands with bot name"
        )
