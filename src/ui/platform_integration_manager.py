...
class PlatformIntegrationManager(QObject):
    ...
    def create_tray_icon(self) -> QIcon:
        ...
        try:
            ...
            icon_paths = ["assets/icon.png", "assets/icon.ico", "src/ui/static/favicon.ico"]
    ...
    def init_windows_integration(self, settings_manager=None) -> bool:
        ...
        try:
            ...
            if success:
                ...
                self.windows_manager.taskbar_progress_changed.connect(
                    self.taskbar_progress_request.emit
                )
    ...
    def get_platform_info(self) -> Dict[str, Any]:
        ...
        info = {
            ...
            "system_tray_available": (
                QSystemTrayIcon.isSystemTrayAvailable() if PYSIDE6_AVAILABLE else False
            ),
            "features": {
        ...
        if self.is_macos:
            info["features"].update({"menu_bar": True, "dock": True, "auto_start": True})
        elif self.is_windows:
            info["features"].update({"taskbar": True, "auto_start": True, "jump_lists": True})
        elif self.is_linux:
            info["features"].update({"desktop_integration": True, "auto_start": True})
