...
try:
    from PySide6.QtWidgets import (
        ...
        QProgressBar, QFrame, QScrollArea, QSplitter, QButtonGroup,
        QRadioButton, QDoubleSpinBox, QApplication, QGridLayout
    )
...
class NativeSettingsDialog(QDialog):
    ...
    def create_ui_tab(self):
        ...
        self.font_family_combo.addItems([
            "default", "-apple-system", "Segoe UI", "system-ui",
            "Arial", "Helvetica", "Roboto", "Source Sans Pro"
        ])
