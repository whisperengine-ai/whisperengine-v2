...
class EnhancedBotCore:
    ...
    def __init__(self, debug_mode: bool = False, use_datastore_factory: bool = True):
        ...
        logger.info(f"EnhancedBotCore initialized (datastore_factory: {self.use_datastore_factory})")
    ...
    def _initialize_minimal_components(self):
        ...
        try:
            ...
            if not self.base_bot_core.memory_manager:
                ...
                self.base_bot_core.memory_manager = type('MockMemoryManager', (), {
            ...
            if not self.base_bot_core.safe_memory_manager:
                ...
                setattr(self.base_bot_core, 'safe_memory_manager', self.base_bot_core.memory_manager)
    ...
    async def initialize_datastore_components(self):
        ...
        try:
            ...
            if 'conversation_cache' in self.datastore_components:
                self.base_bot_core.conversation_cache = self.datastore_components['conversation_cache']
...
def create_enhanced_bot_core(debug_mode: bool = False, use_datastore_factory: bool = True) -> EnhancedBotCore:
    """Create an enhanced bot core instance"""
    return EnhancedBotCore(
        debug_mode=debug_mode,
        use_datastore_factory=use_datastore_factory
    )