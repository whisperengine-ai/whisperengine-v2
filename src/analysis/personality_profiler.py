...
class PersonalityProfiler:
    ...
    def __init__(self):
        ...
        self._formal_indicators = {
            'words': ['furthermore', 'therefore', 'consequently', 'nevertheless', 'moreover', 
                     'request', 'assistance', 'proceed', 'recommend', 'professional', 'formal',
                     'consider', 'propose', 'beneficial', 'appropriate'],
        ...
        self._casual_indicators = {
            'words': ['yeah', 'nah', 'gonna', 'wanna', 'kinda', 'sorta', 'btw', 'lol', 'omg',
                     'hey', 'what\'s up', 'ngl', 'awesome', 'thing'],
        ...
        self._confidence_indicators = {
            'high': ['definitely', 'certainly', 'absolutely', 'obviously', 'clearly', 
                    'know this is', 'will work', 'best solution', 'most effective', 'perfect'],
            'low': ['maybe', 'perhaps', 'possibly', 'might', 'could be', 'not sure', 'i think',
                   'i guess', 'worried', 'not certain']
        }
        ...
        self._decision_indicators = {
            ...
            'analytical': ['pros and cons', 'research', 'data', 'evidence', 'study', 'analyze',
                          'evaluate', 'thoroughly', 'potential risks', 'benefits']
        }
    ...
    def _analyze_big_five_indicators(self, message: str, doc) -> Dict[str, float]:
        ...
        # Openness indicators
        openness_words = ['creative', 'imagination', 'new', 'different', 'unique', 'innovative', 'explore']
        for word in openness_words:
            if word in message_lower:
                indicators['openness'] += 0.1
        
        # Conscientiousness indicators
        conscientiousness_words = ['plan', 'organize', 'careful', 'detail', 'complete', 'finish', 'responsible',
                                 'analyze', 'evaluate', 'consider', 'review', 'thorough', 'research']
        ...
        neuroticism_words = ['worry', 'stress', 'anxious', 'nervous', 'problem', 'difficult', 'hard',
                           'worried', 'not sure', 'not certain', 'might', 'maybe']
    ...
    def _aggregate_personality_metrics(self, message_stats: List[Dict], metrics: PersonalityMetrics) -> PersonalityMetrics:
        ...
        metrics.emotional_expressiveness = statistics.mean([s['emotional_intensity'] for s in message_stats])
        ...
        all_conscientiousness = [s['big_five_indicators']['conscientiousness'] for s in message_stats]
        ...
        metrics.conscientiousness = statistics.mean(all_conscientiousness) if all_conscientiousness else 0.5
        ...
        metrics.detail_orientation = metrics.conscientiousness * 0.7 + metrics.complexity_score * 0.3
        metrics.abstract_thinking = metrics.openness * 0.8 + metrics.complexity_score * 0.2
        metrics.social_engagement = metrics.extraversion * 0.6 + metrics.emotional_expressiveness * 0.4
    ...
    def get_personality_summary(self, metrics: PersonalityMetrics) -> Dict[str, Any]:
        ...
        summary = {
            ...
            'personality_traits': {
                ...
                'conscientiousness': self._score_to_label(metrics.conscientiousness, 'conscientiousness'),
            ...
            'behavioral_patterns': {
                ...
                'emotional_expressiveness': self._score_to_label(metrics.emotional_expressiveness, 'emotion'),
