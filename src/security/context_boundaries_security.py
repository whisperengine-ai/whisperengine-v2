...
class ContextBoundariesManager:
    ...
    def request_consent(
        ...
        self._log_decision(
            ...
            target_context,
            "consent_requested",
            "User consent required for cross-context sharing",
    ...
    def _generate_consent_message(self, source_context: str, target_context: str) -> str:
        ...
        return (
            f"🔒 **Privacy Notice**: I have information from your {source_name} "
        ...
        try:
            ...
            if response == "allow_once":
                ...
                self._log_decision(
                    ...
                    target_context,
                    "allowed_always",
                    "User granted permanent consent",
                    prefs.privacy_level.value,
                )
    ...
    def check_context_boundary_permission(
        self,
        user_id: str,
        source_context: str,
        target_context: str,
        ...
        try:
            ...
            if prefs.custom_rules and rule_key in prefs.custom_rules:
                ...
                self._log_decision(
                    ...
                    f"Custom rule: {rule_key}",
                    prefs.privacy_level.value,
                )

                return {"allowed": allowed, "reason": "custom_rule", "requires_consent": False}
