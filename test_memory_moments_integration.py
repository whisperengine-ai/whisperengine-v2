...
async def test_memory_moments_integration():
    ...
    try:
        ...
        try:
            ...
            print(f"✅ Conversation analysis completed: {len(memory_connections)} connections found")
        ...
        try:
            ...
            print(f"✅ Memory moments generation completed: {len(memory_moments_result)} moments generated")
