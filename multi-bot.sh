...
AVAILABLE_BOTS=("marcus" "dream" "marcus-chen" "elena" "gabriel")
...
show_usage() {
    ...
    echo ""
    echo "Available bots: marcus dream marcus-chen elena gabriel"
    echo ""
    echo "Examples:"
    echo "  $0 list"
    echo "  $0 start elena"
...
validate_bot_name() {
    ...
    echo -e "Available bots: marcus dream marcus-chen elena gabriel"
    return 1
}
