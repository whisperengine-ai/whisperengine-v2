...
AVAILABLE_BOTS=("jake" "marcus" "dotty" "dream" "elena" "aethys" "ryan" "gabriel" "sophia")
...
show_usage() {
    ...
    echo ""
    echo "Available bots: jake marcus dotty dream elena aethys ryan gabriel sophia"
    echo ""
    echo "Examples:"
    echo "  $0 list"
    echo "  $0 start elena"
...
validate_bot_name() {
    ...
    echo -e "Available bots: jake marcus dotty dream elena aethys ryan gabriel sophia"
    return 1
}
