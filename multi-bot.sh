...
AVAILABLE_BOTS=("jake" "marcus" "dream" "elena" "ryan" "gabriel" "sophia")
...
show_usage() {
    ...
    echo ""
    echo "Available bots: jake marcus dream elena ryan gabriel sophia"
    echo ""
    echo "Examples:"
    echo "  $0 list"
    echo "  $0 start elena"
...
validate_bot_name() {
    ...
    echo -e "Available bots: jake marcus dream elena ryan gabriel sophia"
    return 1
}
