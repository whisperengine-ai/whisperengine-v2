...
def test_conversation_summary_basic():
    ...
    user_msg1.content = "I'm having trouble with my Python project. Can you help me debug this function?"
    
    bot_msg1 = Mock()
    bot_msg1.author.bot = True
    bot_msg1.content = "I'd be happy to help you debug your Python function. Can you share the code?"
    
    user_msg2 = Mock()  
    user_msg2.author.id = 12345
    user_msg2.content = "Here's the function that's not working correctly: def calculate_average(numbers):"
    
    bot_msg2 = Mock()
    bot_msg2.author.bot = True
    bot_msg2.content = "I see the issue with your function. You need to handle the empty list case..."
