...
def test_real_conversation_scenario():
    ...
    user_msg1.content = "I'm working on a machine learning project and need help understanding neural networks"
    ...
    user_msg2.content = "I'm particularly confused about backpropagation and how the gradients are calculated"
    ...
    assert "machine learning" in summary.lower() or "neural network" in summary.lower(), "Should capture ML topics"
    assert "backpropagation" in summary.lower() or "gradient" in summary.lower(), "Should capture technical details"
...
def test_mixed_users_scenario():
    ...
    user_c_msg1.content = "Has anyone tried Rust programming language? It's supposed to be very fast"
    ...
    assert "pandas" in summary_a or "numpy" in summary_a, "Should contain User A's data science content"
...
def test_command_filtering_scenario():
    ...
    user_real_msg.content = "I'm interested in learning about quantum computing and its applications"
    messages.append(user_real_msg)
    
    # Bot gives a real response
    bot_real_response = Mock()
    bot_real_response.author.bot = True
    bot_real_response.content = "Quantum computing is a fascinating field that leverages quantum mechanical phenomena..."
