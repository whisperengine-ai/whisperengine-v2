...
class TestAdvancedThreadManager:
    ...
    async def test_engagement_assessment(self, thread_manager):
        ...
        low_engagement = thread_manager._assess_engagement_level("Ok fine whatever.")
...
class TestSupportingClasses:
    ...
    def test_transition_detector(self):
        ...
        # Test no transition
        result2 = asyncio.run(
            detector.detect_transition("That's exactly what I was thinking about this topic.")
        )
...
def run_manual_tests():
    ...
    async def run_tests():
        ...
        try:
            ...
            transition_message = (
                "Actually, let's talk about something completely different - cooking!"
            )
