...
def test_system_message_sanitization():
    ...
    test_cases = [
        ...
        {
            "input": [{"role": "system", "content": "You are Dream from Neil Gaiman's The Sandman series, a conceptual being who is the embodiment and ruler of dreams and nightmares."}],
            "description": "Character identity system message",
            "should_be_filtered": True
        },
        {
            "input": [{"role": "system", "content": "##Archive\n##Identity: You are an eternal being, you exist at the center of this cathedral of reality."}],
            "description": "Structured system prompt",
            "should_be_filtered": True
        },
        {
            "input": [{"role": "system", "content": "Previous conversation context:\nuser_id: 123456789\nemotion_context: relationship level high, interaction_count: 45"}],
            "description": "User data in system message",
            "should_be_filtered": True
        },
        {
            "input": [{"role": "system", "content": "ChromaDB collection: user_memories, conversation_context.append({'role': 'system', 'content': DEFAULT_SYSTEM_PROMPT})"}],
    ...
    for test_case in test_cases:
        ...
        if content_changed:
            ...
            if system_messages_after:
                print(f"      Sample sanitized content: {system_messages_after[0]['content'][:100]}...")
...
def test_response_leakage_detection():
    ...
    for test_case in test_responses:
        ...
        print(f"{status} | {description}")
        print(f"      Expected leakage: {should_have_leakage}, Detected leakage: {actual_has_leakage}")
...
def test_secure_system_message_creation():
    ...
    for test_case in test_cases:
        ...
        test_passed = is_system_message and has_content and (content_is_different == should_be_different)
