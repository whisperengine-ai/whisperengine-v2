...
def _run_memory_integration_test(llm_client):
    ...
    try:
        ...
        memory_manager = UserMemoryManager(
            persist_directory="./test_emotion_chromadb", 
        ...
        test_conversations = [
            ...
            ("I'm working on a Python project and feeling a bit overwhelmed", "I understand. Programming can be challenging sometimes."),
        ...
        context = memory_manager.get_emotion_aware_context(user_id, "help with programming", limit=3)
