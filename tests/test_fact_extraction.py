...
def test_fact_extraction():
    ...
    test_cases = [
        ...
        {
            "message": "I am learning to play the guitar",
            "expected_facts": ["is learning guitar"]
        }
    ]
        ...
        try:
            ...
            if extracted_facts:
                ...
                for fact in extracted_facts:
                    confidence_emoji = "🟢" if fact['confidence'] >= 0.8 else "🟡" if fact['confidence'] >= 0.6 else "🔴"
                    print(f"      {confidence_emoji} {fact['fact']} (confidence: {fact['confidence']:.1%}, category: {fact['category']})")
                passed_tests += 1
            else:
