...
def test_global_facts_disabled():
    ...
    print(f"   Global fact extractor before disable: {memory_manager.global_fact_extractor is not None}")
    ...
    if hasattr(memory_manager, 'global_fact_extractor'):
        ...
        print(f"   Global fact extractor after disable: {memory_manager.global_fact_extractor is None}")
