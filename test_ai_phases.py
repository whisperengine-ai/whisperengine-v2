...
if phase2:
    ...
    print(f'Phase 2 methods: {[m for m in dir(phase2) if not m.startswith("_") and callable(getattr(phase2, m))]}')
else:
...
if phase3:
    ...
    print(f'Phase 3 methods: {[m for m in dir(phase3) if not m.startswith("_") and callable(getattr(phase3, m))]}')
else:
