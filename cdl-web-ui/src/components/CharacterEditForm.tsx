      ...
      <div className="space-y-8">
        ...
        {activeTab === 'identity' && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-600 rounded-md px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
              </div>
              <div>
            ...
            <div>
              <h3 className="text-lg font-medium text-gray-100 mb-4">Voice Characteristics</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Pace</label>
                  <input
                    type="text"
            ...
            {/* Essence */}
            <div>
              <h3 className="text-lg font-medium text-gray-100 mb-4">Essence</h3>
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Core Identity</label>
                  <textarea
        ...
        {activeTab === 'personality' && (
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {['openness', 'conscientiousness', 'extraversion', 'agreeableness', 'neuroticism'].map((trait) => (
                  <div key={trait} className="border border-gray-700 rounded-lg p-4">
                    <h4 className="font-medium text-gray-100 mb-3 capitalize">{trait}</h4>
                    <div>
                      <label className="block text-sm text-gray-300 mb-1">Score (0.0 - 1.0)</label>
                      <input
                        type="number"
                        min="0"
                        max="1"
            ...
            {/* Communication Style */}
            <div>
              <h3 className="text-lg font-medium text-gray-100 mb-4">Communication Style</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Tone</label>
                  <input
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Directness</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Empathy Level</label>
                  <input
                    type="text"
        ...
        {activeTab === 'communication' && (
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-lg font-medium text-gray-100 mb-4">AI Identity Handling</h3>
              <div className="space-y-4">
                <div>
        ...
        {activeTab === 'knowledge' && (
          <div className="space-y-6">
            {/* Areas of Expertise */}
            <div>
              <h3 className="text-lg font-medium text-gray-100 mb-4">Areas of Expertise</h3>
              <div className="space-y-2">
            ...
            {/* Background */}
            <div>
              <h3 className="text-lg font-medium text-gray-100 mb-4">Background</h3>
              <div className="space-y-4">
                <div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Career</label>
                  <textarea
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Personal</label>
                  <textarea
        ...
        {activeTab === 'llm-config' && (
          <div className="space-y-6">
            <div className="bg-gray-900 p-6 rounded-lg">
              <h3 className="text-lg font-medium text-gray-100 mb-4">LLM Provider Configuration</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
              ...
              <h4 className="text-md font-medium text-gray-100 mt-6 mb-4">Advanced Settings</h4>
          ...
          <div className="space-y-6">
            <div className="bg-gray-900 p-6 rounded-lg">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-medium text-gray-100">Discord Integration</h3>
                <label className="flex items-center">
                  <input
                    ...
                    className="mr-2"
                  />
                  <span className="text-sm font-medium text-gray-300">Enable Discord</span>
                </label>
              </div>
              ...
              {discordConfig.enable_discord && (
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-2">Application ID</label>
                      <input
                        type="text"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-2">Response Delay Min (ms)</label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-2">Response Delay Max (ms)</label>
                      <input
                        type="number"
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="mr-2"
                    />
                    <label className="text-sm font-medium text-gray-300">Show typing indicator</label>
                  </div>
                </div>
              )}
            </div>
        ...
        {activeTab === 'deployment' && (
          <div className="space-y-6">
            <div className="bg-gray-900 p-6 rounded-lg">
              <h3 className="text-lg font-medium text-gray-100 mb-4">Deployment Configuration</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Memory Limit</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Health Check Port</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Deployment Status</label>
                  <select
              ...
              <div className="mt-4">
                <label className="block text-sm font-medium text-gray-300 mb-2">Environment Overrides (JSON)</label>
                <textarea
                  ...
                  className="w-full border border-gray-600 rounded-md px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-mono text-sm"
                />
