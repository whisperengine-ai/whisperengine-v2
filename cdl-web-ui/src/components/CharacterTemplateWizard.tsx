...
export default function CharacterTemplateWizard({ onTemplateSelected, onCustomCreate }: CharacterWizardProps) {
  ...
  if (showTemplateDetails && selectedTemplate) {
    return (
      <div className="max-w-4xl mx-auto bg-gray-800 rounded-lg shadow-lg p-8">
        ...
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-100 mb-2">{selectedTemplate.name}</h2>
          <p className="text-gray-400 text-lg mb-4">{selectedTemplate.description}</p>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-gray-900 rounded-lg p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                <span className="text-gray-300">Memory Retention:</span>
              ...
              <div className="flex justify-between items-center">
                <span className="text-gray-300">Attachment Risk:</span>
            ...
            <div className="mt-4">
              <h4 className="font-medium text-gray-300 mb-2">Growth Areas:</h4>
          ...
          <div className="bg-gray-900 rounded-lg p-6">
            ...
            <div className="space-y-3">
              <div>
                <span className="text-gray-300 font-medium">Occupation:</span>
                <p className="text-gray-100">{selectedTemplate.cdlData.identity.occupation}</p>
              </div>
              <div>
              ...
              <div>
                <span className="text-gray-300 font-medium">AI Identity Approach:</span>
                <p className="text-gray-100">
                  {selectedTemplate.cdlData.communication.ai_identity_handling.approach.replace('_', ' ')}
                </p>
              </div>
              <div>
                <span className="text-gray-300 font-medium">Core Values:</span>
        ...
        <div className="flex gap-4 justify-center">
          ...
          <button
            onClick={() => setShowTemplateDetails(false)}
            className="bg-gray-300 text-gray-300 px-8 py-3 rounded-lg font-semibold hover:bg-gray-400 transition-colors"
          >
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      {/* Category Filter */}
      <div className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-100 mb-4">Choose a Category</h2>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        {filteredTemplates.map((template) => (
          <div
            ...
            className="bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-shadow cursor-pointer p-6 border-2 border-transparent hover:border-blue-300"
          >
            <div className="text-center mb-4">
              <div className="text-4xl mb-2">{template.icon}</div>
              <h3 className="text-xl font-semibold text-gray-100 mb-2">{template.name}</h3>
