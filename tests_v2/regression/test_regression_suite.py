...
BOT_CONFIGS = [
    ...
    BotConfig("nottaylor", 8008, "mistralai/mistral-small-3.1-24b-instruct", "mistralai/mistral-medium-3.1", is_production=True),
    BotConfig("gabriel", 8009, "mistralai/mistral-small-3.1-24b-instruct", "mistralai/mistral-medium-3.1"),
    BotConfig("aethys", 8010, "mistralai/mistral-small-3.1-24b-instruct", "mistralai/mistral-medium-3.1"),
