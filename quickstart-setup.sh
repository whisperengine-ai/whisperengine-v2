...
echo "   • OpenRouter (recommended) - Easy setup with multiple models"
echo "   • LM Studio (free, local) - Privacy-focused local AI"
echo "   • OpenAI (paid, cloud) - Premium GPT models"
echo ""
echo "   ${BLUE}📖 For detailed configuration help:${NC}"
echo "   https://github.com/whisperengine-ai/whisperengine/blob/main/docs/guides/edit-env-after-quickstart.md"
echo ""
...
echo "   ${YELLOW}docker-compose -f docker-compose.quickstart.yml up -d${NC}"
echo ""
echo "3. 🌐 Access your AI assistant:"
echo "   • Web UI: ${BLUE}http://localhost:3001${NC} (Character management)"
echo "   • HTTP API: ${BLUE}http://localhost:9090/api/chat${NC} (Direct chat)"
echo "   • InfluxDB: ${BLUE}http://localhost:8086${NC} (Metrics dashboard)"
echo ""
...
echo "   ${YELLOW}  -d '{\"user_id\": \"test\", \"message\": \"Hello, AI Assistant!\"}'${NC}"
echo ""
echo "5. 📊 Monitor your system:"
echo "   ${YELLOW}docker-compose -f docker-compose.quickstart.yml logs -f whisperengine-assistant${NC}"
echo ""
