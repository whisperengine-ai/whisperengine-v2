...
async def main():
    ...
    try:
        ...
        if benchmark_results:
            logger.info(f"✅ Faiss is {benchmark_results['speed_improvement']:.1f}x faster than estimated ChromaDB")
        ...
        if stress_results:
            logger.info(f"✅ Handled {stress_results['add_throughput']:.0f} adds/s and {stress_results['search_throughput']:.0f} searches/s")
