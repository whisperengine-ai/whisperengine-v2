...
class CompletePhase4SystemDemo:
        ...
        if ENGAGEMENT_ENGINE_AVAILABLE:
            try:
                self.engagement_engine = await create_proactive_engagement_engine(
                    thread_manager=self.thread_manager, memory_moments=self.memory_moments
                )
                ...
                "conversations": [
                    {
                        ...
                        "messages": [
                            {
                                "content": "I've been thinking about changing my career path to data science.",
                                "timestamp_offset": 0,
                            },
                            {
                                "content": "I have a background in marketing but I'm passionate about analytics.",
                                "timestamp_offset": 60,
                            },
                            {
                                "content": "The transition seems daunting though.",
                                "timestamp_offset": 180,
                            },
                            {
                                "content": "Yeah...",
                                "timestamp_offset": 600,
                            },  # This should trigger proactive engagement
                        ],
                    },
                    {
                        ...
                        "messages": [
                            {
                                "content": "I started learning Python last week and it's been exciting!",
                            ...
                            {
                                "content": "I'm working through some data analysis tutorials.",
                ...
                "conversations": [
                    {
                        ...
                        "messages": [
                            {
                                "content": "I had a really difficult conversation with my manager today.",
                                "timestamp_offset": 0,
                            },
                            {
                                "content": "They questioned my recent project decisions and I felt defensive.",
                                "timestamp_offset": 120,
                            },
                            {
                                "content": "I don't think I handled it well.",
                    ...
                    },
                    {
                        ...
                        "messages": [
                            {
                                "content": "I've been thinking about our conversation yesterday about work challenges.",
                                "timestamp_offset": 86400,
                            },  # Next day
                            {
                                "content": "I think I want to approach my manager differently.",
                                "timestamp_offset": 86460,
                            },
                        ],
                    },
                ],
                ...
                "conversations": [
                    {
                        ...
                        "messages": [
                            {
                                "content": "I'm trying to decide what to do this weekend.",
                                "timestamp_offset": 0,
                            },
                            {
                                "content": "Maybe I'll visit that new art museum downtown.",
                                "timestamp_offset": 60,
                            },
                        ],
                    },
                    {
                        ...
                        "messages": [
                            {
                                "content": "Actually, before I forget - do you have any good pasta recipe recommendations?",
                                "timestamp_offset": 120,
                            },
                            {
                                "content": "I want to try cooking something new tonight.",
                    ...
                    },
                    {
                        ...
                        "messages": [
                            {
                                "content": "Going back to weekend plans - the museum has a new contemporary exhibit.",
                                "timestamp_offset": 300,
                            },
                            {
                                "content": "I heard it's really thought-provoking.",
                                "timestamp_offset": 360,
                            },
                            {
                                "content": "Hmm, not sure though.",
                                "timestamp_offset": 600,
                            },  # Should trigger engagement
                        ],
                    },
                ],
                "expected_features": [
    ...
    async def run_integrated_scenario(self, scenario: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for conv_idx, conversation in enumerate(scenario["conversations"]):
            ...
            for msg_idx, message_data in enumerate(conversation["messages"]):
                message_timestamp = base_timestamp + timedelta(
                    seconds=message_data["timestamp_offset"]
                )
                ...
                if self.thread_manager:
                    try:
                        ...
                        if thread_result and thread_result.get("current_thread"):
                            ...
                            logger.info(
                                "   📊 Thread priority: %s",
                                thread_result.get("priority", "unknown"),
                            )
                            scenario_results["phase4_features_demonstrated"].append(
                                "thread_management"
                            )
                ...
                if self.memory_moments:
                    try:
                        ...
                        logger.info(
                            "   🧠 Memory context analyzed for topic: %s",
                            conversation["thread_topic"],
                        )
                        scenario_results["phase4_features_demonstrated"].append(
                            "memory_integration"
                        )
                ...
                if self.engagement_engine:
                    try:
                        ...
                        if engagement_result:
                            ...
                            intervention_needed = engagement_result.get(
                                "intervention_needed", False
                            )

                            logger.info(
                                "   💡 Engagement: %s (score: %.2f)", flow_state, engagement_score
                            )
                            ...
                            if intervention_needed:
                                ...
                                scenario_results["proactive_interventions"].append(
                                    intervention_data
                                )
                                scenario_results["phase4_features_demonstrated"].append(
    ...
    def _analyze_integration_performance(self, results: Dict[str, Any], scenario: Dict[str, Any]):
        ...
        logger.info(
            "   Threads created: %d (%s)",
            len(results["threads_created"]),
            ", ".join(results["threads_created"][:2]),
        )
        logger.info("   Proactive interventions: %d", len(results["proactive_interventions"]))
        logger.info(
            "   Phase 4 features demonstrated: %s",
            ", ".join(set(results["phase4_features_demonstrated"])),
        )
        ...
        for feature in expected_features:
            if any(
                feature_part in str(features_demonstrated) for feature_part in feature.split("_")
            ):
        ...
        if performance_ratio >= 0.8:
            logger.info(
                "   🎯 INTEGRATION PERFORMANCE: EXCELLENT (%.0f%%)", performance_ratio * 100
            )
            ...
            logger.info(
                "   ❌ INTEGRATION PERFORMANCE: NEEDS IMPROVEMENT (%.0f%%)", performance_ratio * 100
            )
        ...
        if self.engagement_engine:
            ...
            try:
                ...
                if engagement_result:
                    ...
                    logger.info(
                        "   💬 Flow state: %s", engagement_result.get("flow_state", "unknown")
                    )
    ...
    def _display_complete_system_summary(self, results: Dict[str, Any]):
        ...
        logger.info(
            "🔧 System Availability: %d/%d systems operational", available_count, total_systems
        )
        ...
        logger.info("")
        logger.info(
            "💪 System Capabilities: %d/%d capabilities working",
        ...
        successful_scenarios = sum(
            1 for s in scenario_results if s.get("integration_success", False)
        )

        logger.info("")
        logger.info(
            "🎭 Integrated Scenarios: %d/%d successful", successful_scenarios, len(scenario_results)
        )
        ...
        for scenario in scenario_results:
            if scenario.get("integration_success", False):
                ...
                logger.info(
                    "      - Threads: %d, Interventions: %d, Features: %s",
                    threads,
                    interventions,
                    ", ".join(set(features)),
                )
        ...
        logger.info(
            "   Unique features demonstrated: %d (%s)", len(all_features), ", ".join(all_features)
        )
        ...
        # Final assessment
        success_rate = (
            (successful_scenarios / len(scenario_results)) * 100 if scenario_results else 0
        )
        capability_rate = (
            (working_capabilities / total_capabilities) * 100 if total_capabilities else 0
        )
