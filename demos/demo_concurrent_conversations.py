...
class MockAdvancedThreadManager:
    ...
    async def process_user_message(self, user_id: str, message: str, context: Dict[str, Any]) -> Dict[str, Any]:
...
def generate_concurrent_users(num_users: int, messages_per_user: int) -> List[Dict[str, Any]]:
    ...
    conversation_scenarios = [
        ...
        {"topics": ["project management", "career goals", "team collaboration"], "urgency": "normal"},
        {"topics": ["job interview", "resume help", "workplace conflict"], "urgency": "high"},
        
        # Personal conversations  
        {"topics": ["relationship advice", "personal growth", "life decisions"], "urgency": "normal"},
        ...
        {"topics": ["learning new skills", "educational questions", "study help"], "urgency": "low"},
        {"topics": ["exam preparation", "assignment help", "concept clarification"], "urgency": "normal"},
        
        # Creative conversations
        {"topics": ["creative writing", "artistic feedback", "brainstorming"], "urgency": "low"},
        {"topics": ["deadline project", "creative block", "urgent inspiration"], "urgency": "normal"},
    ]
...
async def test_priority_queue_performance():
    ...
    try:
        ...
        print(f"  🚀 High-priority messages first: {high_priority_first}/100 ({high_priority_first}%)")
...
async def test_session_management():
    ...
    try:
        ...
        expected_active = sum(scenario["users"] for scenario in session_scenarios if scenario["active"])
        cleanup_efficiency = (initial_sessions - final_sessions) / initial_sessions if initial_sessions > 0 else 0
...
async def test_load_balancing():
    ...
    try:
        ...
        manager = ConcurrentConversationManager(
            ...
            max_workers_threads=6,
            max_workers_processes=3
        )
        ...
        for pattern in load_patterns:
            ...
            # Create burst tasks
            burst_tasks = [
                burst_user(f"burst_user_{i}", messages_per_user)
