...
class WhisperBot(commands.Bot):
    ...
    async def setup_hook(self) -> None:
        ...
        # self.daily_scheduler.start()  # Disabled in favor of Event-Driven Architecture (The Stream)
        self.action_poller.start()    # Re-enabled to execute actions generated by The Stream
