#!/usr/bin/env python3
"""
Simple Bot Memory Isolation Test - Local Version

Tests that different bot names result in separate memory storage.
Uses localhost for Qdrant connection.
"""
...
async def test_memory_isolation():
    ...
    try:
        ...
        print("\n🔧 Debug Info:")
        print(f"   Elena search results: {len(elena_results)}")
        print(f"   Gabriel search results: {len(gabriel_results)}")
